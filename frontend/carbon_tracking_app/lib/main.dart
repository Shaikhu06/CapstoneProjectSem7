...
void main() {
  runApp(
    MaterialApp(
      home: CarbonEmissionCalculator(),
      debugShowCheckedModeBanner: false,
    ),
  );
}

class CarbonEmissionCalculator extends StatefulWidget {
  @override
  _CarbonEmissionCalculatorState createState() =>
      _CarbonEmissionCalculatorState();
}

class _CarbonEmissionCalculatorState extends State<CarbonEmissionCalculator> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Carbon Emission Calculator')),
      body: Container(
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text(
                    'Carbon Emission: $_result kg CO2',
